...
void arg_h(void)
{
    ...
    my_putstr("obstacles and enemies.\n");
    my_putstr("•as the player runs, a score, which will be displayed, will");
    my_putstr("increase.\n");
    my_putstr("•when the player dies or finishes the map, the score is");
    my_putstr("displayed inside the window.\n\n");
}
